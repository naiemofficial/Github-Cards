...
<style type="text/css">
    ...
    .github-card-wrapper-preloader {
        ...
        ?>
        backdrop-filter: <?php echo $backdrop_enabled ? $blur_px : 'none!important;'; ?>
        -webkit-backdrop-filter: <?php echo $backdrop_enabled ? $blur_px : 'none!important;'; ?>
    }
    ...
    /* Skeleton Color */
    <?php if(!empty($skeleton_primary_color) && !empty($skeleton_secondary_color)): ?>
        .github-card .github-card-skeleton::before {
    ...
    /* Footer Ribbon Color */
    <?php 
    if(github_card_footer_ribbon() && !empty(github_card_footer_ribbon_color())){
    ?>
